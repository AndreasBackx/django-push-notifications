...
def _apns_prepare(token, alert, application_id=None, badge=None, sound=None,
                  category=None, content_available=False, action_loc_key=None,
                  loc_key=None, loc_args=[], extra={}, mutable_content=False,
...
def _apns_send(registration_id, alert, batch=False, application_id=None, certfile=None,
               **kwargs):
...
def apns_send_message(registration_id, alert, application_id=None, certfile=None,
                      **kwargs):
    """
...
def apns_send_bulk_message(registration_ids, alert, application_id=None, certfile=None,
                           **kwargs):
    """
